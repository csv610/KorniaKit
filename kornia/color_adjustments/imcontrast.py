...
img1 = kornia.enhance.adjust_contrast(img, 0.4)
img1:np.array = kornia.tensor_to_image(img1)
cv2.imshow("bright1", img1)

img2 = kornia.enhance.adjust_contrast(img, 0.8)
img2:np.array = kornia.tensor_to_image(img2)
cv2.imshow("bright2", img2)

img3 = kornia.enhance.adjust_contrast(img, 3.0)
img3:np.array = kornia.tensor_to_image(img3)
cv2.imshow("bright3", img3)
